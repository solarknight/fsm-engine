...
import com.github.solarknight.fsm.core.annotation.StateGetter;
import com.github.solarknight.fsm.core.annotation.StateSetter;
...
import com.github.solarknight.fsm.core.util.Pair;
...
public class FSMModel {
  ...
  private FSMPersistence persistence;
  ...
  private static void fillAttributes(FSMModel model, FSMBuilder fsmBuilder) {
    ...
    model.setPersistence(fsmBuilder.getPersistence());
  }
  ...
  public FSMPersistence getPersistence() {
    return persistence;
  }

  public void setPersistence(FSMPersistence persistence) {
