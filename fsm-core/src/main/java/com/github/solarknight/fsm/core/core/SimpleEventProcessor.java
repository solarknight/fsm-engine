...
import com.github.solarknight.fsm.core.element.EventProcessor;
...
import com.github.solarknight.fsm.core.element.TransitionContext;
...
public class SimpleEventProcessor implements EventProcessor {
  ...
  private <T extends FSMMixin> void persist(T t, FSMModel model) {
    model.getPersistence().persist(t);
  }
